...
<!-- Primary Meta Tags -->
<title>Bucador de programas analíticos</title>
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
<meta name="title" content="Bucador de programas analíticos">
...
<meta property="og:title" content="Bucador de programas analíticos">
...
<meta property="twitter:title" content="Bucador de programas analíticos">
...
<body>
  ...
  <a class="navbar-brand me-lg-5" href="#">
    <span class="navbar-brand-dark">
      <img src="../assets/img/brand/logo-color.svg" height="32" width="32" alt="Pimienta Logo">
    </span>
    <span class="mt-1 ms-1 sidebar-text"><strong>P<span class="text-secondary">imient</span>A</strong></span>
  </a>
      ...
      <li class="nav-item">
        <a href="#" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon">
            <img src="../assets/img/brand/logo-color.svg" height="24" width="24" alt="Pimienta Logo">
          </span>
          <span class="mt-1 ms-1 sidebar-text"><strong>P<span class="text-secondary">imient</span>A</strong></span>
        </a>
      </li>

      <!-- Buscador de programas analíticos -->
      <li class="nav-item  active ">
        <a href="/" class="nav-link d-flex justify-content-between">
          <span>
            <span class="sidebar-icon">
              <svg class="icon icon-xs me-2" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="sidebar-text">Buscador</span>
          </span>
          <span>
            <span class="badge badge-sm bg-secondary ms-1 text-gray-800">pdf</span>
          </span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <span
          ...
          <span>
            ...
            <span class="sidebar-text">Programas Analític.</span>
          </span>
        ...
        <div class="multi-level collapse "
          ...
          <ul class="flex-column nav">
            <li class="nav-item ">
              <a class="nav-link ms-2" href="/programa-analitico">
                <span class="sidebar-text">
                  <span class="sidebar-icon">
                    <svg class="icon icon-xs me-0" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item ">
              <a class="nav-link ms-2" href="/programa-analitico/create">
                <span class="sidebar-text">
                  <span class="sidebar-icon">
                    <svg class="icon icon-xs me-0" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
  ...
  <main class="content">
    <nav class="navbar navbar-top navbar-expand navbar-dashboard navbar-dark ps-0 pe-2 pb-0 bg-secondary">
  <div class="container-fluid px-0">
    <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
      ...
      @if (session('status'))
        <div class="alert alert-success alert-dismissible fade show" role="alert" data-bs-dismiss="alert" aria-label="Close">
          <svg class="icon icon-xs" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path clip-rule="evenodd" d="M9 1.5H5.625c-1.036 0-1.875.84-1.875 1.875v17.25c0 1.035.84 1.875 1.875 1.875h12.75c1.035 0 1.875-.84 1.875-1.875V12.75A3.75 3.75 0 0016.5 9h-1.875a1.875 1.875 0 01-1.875-1.875V5.25A3.75 3.75 0 009 1.5zm6.61 10.936a.75.75 0 10-1.22-.872l-3.236 4.53L9.53 14.47a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.14-.094l3.75-5.25z" fill-rule="evenodd"></path>
    ...
    <div class="py-4">
      <div class="d-flex justify-content-center w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
          <h1 class="h2 fw-bolder text-primary">Buscador de programas analíticos</h1>
        </div>
      </div>
    </div>
      ...
      <div class="col-12 col-md-8">
        <div class="mb-3">
          <div class="input-group" style="height: 45px;">
            ...
            <input type="search" class="form-control" id="inputSeeker" placeholder="Escriba el nombre o código de la materia" aria-label="Search" autofocus>
          </div>
        </div>
      </div>
    </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <button type="button" class="btn btn-xs btn-primary d-inline-flex align-items-center emitir" data-bs-toggle="modal" data-bs-target="#modal-emitir-pa" id="btn-{{$pa->id}}-{{$pa->materia}}">
...
<footer class="bg-white rounded shadow p-2 mb-4 mt-4">
    <div class="row">
        <div class="col-12 mb-0 text-gray-500">
            <small class="mb-0 text-center text-lg-start">© 2023 - <a class="" href="#" target="_blank">Aux. Carlos Ramos</a></small>
        </div>
    </div>
</footer>
  </main>
...
<div class="modal fade" id="modal-emitir-pa"" tabindex=" -1" role="dialog" aria-labelledby="modal-default"
  aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <form action="/programa-analitico/emision" method="get">
      <div class="modal-header">
        <h2 class="h6 modal-title">Emisión del programa analítico - <span id="label-materia"></span> </h2>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      {{-- @csrf --}}
  ...
  <script>
    ...
    var table = new DataTable('#example', {
        language: {
            ...
            //Se puede incorporar como código para no requerir de internet
        ...
        "dom": 'rtp', // ocultando varios elementos (o mostrando algunos elementos)
        //habilitar scroll Y 
        "scrollY": "45vh",
        "scrollCollapse": true,
        "paging": false,
    ...
    buttonsEmitir.forEach(function(item) {
      item.addEventListener('click', function(e) {
        ...
        let materia = item.getAttribute('id').split('-')[2];
        let headLabelMateria = document.getElementById('label-materia');
        headLabelMateria.innerHTML = materia;
      })
    })
